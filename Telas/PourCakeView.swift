    ...
    var body: some View {
        ...
        ZStack {
            ...
            HStack {
                ...
                // pan conditions
                if viewModel.timeElapsed <= 25 {
                    Image("formaVazia")
                        .scaleEffect(0.5)
                        .offset(CGSize(width: 200, height: 100))
                    
                } else if viewModel.timeElapsed > 25 && viewModel.timeElapsed < 50 {
                    Image("formaMetade")
                        .scaleEffect(0.5)
                        .offset(CGSize(width: 200, height: 100))
                ...
                // blender conditions
                if viewModel.rotation >= -25 && viewModel.timeElapsed < 100 {
                    Image("liquidCheio")
                        .scaleEffect(0.5)
                ...
                } else if viewModel.rotation < -25 && (viewModel.timeElapsed > 25 && viewModel.timeElapsed < 50) {
